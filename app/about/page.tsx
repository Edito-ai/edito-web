      ...
      <div>
        ...
        <section className="pt-32 pb-16 px-6 max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-text-muted text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            We are a tiny team of creators and developers who got tired of spending hours on repetitive editing tasks—like writing captions, trimming pauses, and formatting transcripts. We built Stedtio to put the tedious work on autopilot.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-text-muted leading-relaxed text-[14px]">
                <p>
                  Stedtio started as a side project between three friends. We were editing YouTube videos and TikToks on weekends, and noticed how much time we wasted doing the same tedious tasks over and over—transcribing audio, typing captions, and adjusting aspect ratios.
                </p>
                <p>
