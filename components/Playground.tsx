    ...
    <section id="playground" className="py-20 bg-zinc-950/40 border-y border-zinc-800/40 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Try the Edito Workspace Simulator</h2>
            ...
            <div className="h-12 border-b border-zinc-800 bg-zinc-950/50 flex items-center justify-between px-5">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-zinc-400">
                  {sandboxTab === "write" && "Edito Writer v2.0"}
                  {sandboxTab === "caption" && "Edito Caption Generator"}
                  {sandboxTab === "video" && "Edito Video Timeline Studio"}
                </span>
              </div>
